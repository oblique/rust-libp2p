...
pub(crate) struct Endpoint {
    ...
    pub(crate) certhashes: HashSet<Multihash>,
        ...
        for proto in addr.iter() {
            match proto {
                ...
                Protocol::P2p(peer) => {
                    ...
                    let peer = PeerId::from_multihash(peer)
                        .map_err(|_| Error::InvalidMultiaddr("Invalid peer ID"))?;
...
mod tests {
    ...
    fn multihash_from_str(s: &str) -> Multihash {
